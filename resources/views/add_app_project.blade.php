			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/save-app-project')}}" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
						  <fieldset>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="project_category" required="">
							  </div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="category" required="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Client</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="client" required="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Project Date</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="project_date" required="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Project URL</label>
							  <div class="controls">
								<input type="text" class="input-xlarge" name="project_url" required="">
							  </div>
							</div>
							...
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Add App Project</button>
							</div>
						  </fieldset>
						</form>   
